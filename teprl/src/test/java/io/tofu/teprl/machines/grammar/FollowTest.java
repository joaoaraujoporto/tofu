...
public class FollowTest {
	...
	public void test() {
		...
		g.updateFollow(new Terminal<String,String>("$"));
		System.out.println(g.getFollow(new NonTerminal<String,String>("S")));
		System.out.println(g.getFollow(new NonTerminal<String,String>("A")));
		System.out.println(g.getFollow(new NonTerminal<String,String>("B")));
	}
}
